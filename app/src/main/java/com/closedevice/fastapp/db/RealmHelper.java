...
//    }
//
////    public void addClassRecord(ClassRecordRealm record){
////        mRealm.beginTransaction();
////        mRealm.copyToRealm(record);
////        mRealm.commitTransaction();
////    }
////
////    public List<ClassRecordRealm> findAllClassRecord() {
////        RealmResults<ClassRecordRealm> likeRecords = mRealm.where(ClassRecordRealm.class).findAllSorted("creater_id");
////        return mRealm.copyToRealm(likeRecords);
////    }
////
////    public void removeAllClassRecord() {
////        mRealm.beginTransaction();
////        mRealm.clear(ClassRecordRealm.class);
////        mRealm.commitTransaction();
////    }
//
//}
